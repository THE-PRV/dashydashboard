...
\begin{longtable}{>{\ttfamily}p{4.8cm} >{\raggedright\arraybackslash}p{9.2cm}}
\toprule
...
Screenshots:RootPath &
  ...
  \texttt{\{root\}\textbackslash\{cycleId\}\textbackslash\{associateId\}\textbackslash\{clientId\}\textbackslash\{toolId\}.webp}
  (plus a \texttt{\_thumb.webp} thumbnail). \textbf{Must be OUTSIDE the deployed app folder}
...
\begin{longtable}{>{\ttfamily}p{5.4cm} >{\raggedright\arraybackslash}p{8.6cm}}
\toprule
\normalfont\textbf{Key} & \textbf{Meaning} \\
\midrule
\endhead
